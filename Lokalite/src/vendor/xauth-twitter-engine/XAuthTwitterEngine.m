...
+ (XAuthTwitterEngine *) XAuthTwitterEngineWithDelegate: (NSObject<MGTwitterEngineDelegate> *) delegate {
    return [[[XAuthTwitterEngine alloc] initXAuthWithDelegate: delegate] autorelease];
}


- (XAuthTwitterEngine *) initXAuthWithDelegate: (NSObject<MGTwitterEngineDelegate> *) delegate {
